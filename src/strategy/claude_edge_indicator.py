    ...
    def get_param_schema(cls) -> Dict[str, Any]:
        return {
            ...
            "use_adx_filter": {
                ...
                "description": "Enable ADX-based chop filter",
                "default": True,
            },
            "atr_tp_multiplier": {
                "type": "float",
                "label": "ATR TP Multiplier",
                "description": "Take profit = entry +/- ATR * multiplier (default 2.5)",
                "default": 2.5,
                "min": 1.0,
                "max": 5.0,
            },
            "atr_sl_multiplier": {
                ...
                "description": "Stop loss = entry -/+ ATR * multiplier (default 1.5)",
                "default": 1.5,
                "min": 0.5,
                "max": 3.0,
            },
            "volume_weight": {
                "type": "float",
                "label": "Volume Weight",
                "description": "Weight of volume score in momentum (default 0.3)",
                "default": 0.3,
                "min": 0.0,
                "max": 1.0,
            },
            "use_htf_filter": {
                "type": "bool",
                "label": "Use HTF Filter",
                "description": "Enable 4h higher-timeframe alignment check",
                "default": True,
            },
            "trailing_stop_enabled": {
                "type": "bool",
                "label": "Trailing Stop",
                "description": "Enable trailing stop with ATR-based breakeven",
                "default": True,
            },
