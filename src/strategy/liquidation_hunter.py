    ...
    def get_param_schema(cls) -> Dict[str, Any]:
        return {
            "fear_greed_extreme_fear": {
                ...
                "description": "Fear & Greed Index below this = Extreme Fear (go LONG)",
                "default": 20,
                "min": 5,
                "max": 40,
            },
            "fear_greed_extreme_greed": {
                ...
                "description": "Fear & Greed Index above this = Extreme Greed (go SHORT)",
                "default": 80,
                "min": 60,
                "max": 95,
            },
            "long_short_crowded_longs": {
                "type": "float",
                "label": "Crowded Longs Threshold",
                "description": "L/S Ratio above this = crowded longs (SHORT signal)",
                "default": 2.5,
                "min": 1.5,
                "max": 5.0,
            },
            "long_short_crowded_shorts": {
                "type": "float",
                "label": "Crowded Shorts Threshold",
                "description": "L/S Ratio below this = crowded shorts (LONG signal)",
                "default": 0.4,
                "min": 0.1,
                "max": 0.8,
            },
            "funding_rate_high": {
                "type": "float",
                "label": "High Funding Rate",
                "description": "Funding rate above this strengthens SHORT (decimal, e.g. 0.0005 = 0.05%)",
                "default": 0.0005,
                "min": 0.0001,
                "max": 0.005,
            },
            "funding_rate_low": {
                "type": "float",
                "label": "Low Funding Rate",
                "description": "Funding rate below this strengthens LONG (decimal, e.g. -0.0002 = -0.02%)",
                "default": -0.0002,
                "min": -0.005,
                "max": -0.0001,
            },
            "high_confidence_min": {
                "type": "int",
                "label": "High Confidence Minimum",
                "description": "Minimum confidence when leverage + sentiment align",
                "default": 85,
                "min": 70,
                "max": 95,
            },
            "low_confidence_min": {
                "type": "int",
                "label": "Low Confidence Minimum",
                "description": "Minimum confidence to trade at all",
                "default": 60,
                "min": 40,
                "max": 80,
            },
