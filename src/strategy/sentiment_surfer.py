    ...
    def get_param_schema(cls) -> Dict[str, Any]:
        return {
            "fear_greed_extreme_fear": {
                "type": "int",
                "label": "Extreme Fear Threshold",
                "description": "Fear & Greed below this = contrarian bullish signal",
                "default": 25,
                "min": 5,
                "max": 45,
            },
            "fear_greed_extreme_greed": {
                "type": "int",
                "label": "Extreme Greed Threshold",
                "description": "Fear & Greed above this = contrarian bearish signal",
                "default": 75,
                "min": 55,
                "max": 95,
            },
            "supertrend_atr_period": {
                ...
                "description": "Number of candles for ATR calculation (higher = smoother)",
                "default": 10,
                "min": 5,
                "max": 30,
            },
            "supertrend_multiplier": {
                ...
                "description": "ATR multiplier for band width (higher = fewer signals)",
                "default": 3.0,
                "min": 1.0,
                "max": 6.0,
            },
            "vwap_period_hours": {
                "type": "int",
                "label": "VWAP Period (hours)",
                "description": "Number of hours for VWAP calculation",
                "default": 24,
                "min": 4,
                "max": 72,
            },
            "use_oiwap": {
                "type": "bool",
                "label": "Use OIWAP",
                "description": "Blend OI-Weighted Average Price with VWAP (more accurate fair value)",
                "default": True,
            },
            "weight_news": {
                "type": "float",
                "label": "News Weight",
                "description": "Weight of GDELT news sentiment in scoring",
                "default": 1.0,
                "min": 0.0,
                "max": 3.0,
            },
            "weight_fear_greed": {
                ...
                "description": "Weight of Fear & Greed Index in scoring",
                "default": 1.0,
                "min": 0.0,
                "max": 3.0,
            },
            "weight_vwap": {
                "type": "float",
                "label": "VWAP Weight",
                "description": "Weight of VWAP/OIWAP position in scoring",
                "default": 1.2,
                "min": 0.0,
                "max": 3.0,
            },
            "weight_supertrend": {
                ...
                "description": "Weight of Supertrend indicator in scoring",
                "default": 1.2,
                "min": 0.0,
                "max": 3.0,
            },
            "weight_volume": {
                "type": "float",
                "label": "Volume Weight",
                "description": "Weight of spot volume analysis in scoring",
                "default": 0.8,
                "min": 0.0,
                "max": 3.0,
            },
            "weight_momentum": {
                ...
                "description": "Weight of 24h price momentum in scoring",
                "default": 0.8,
                "min": 0.0,
                "max": 3.0,
            },
            "min_agreement": {
                "type": "int",
                "label": "Min Source Agreement",
                "description": "Minimum number of sources that must agree for trade entry (out of 6)",
                "default": 3,
                "min": 1,
                "max": 6,
            },
