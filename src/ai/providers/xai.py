...
class XAIProvider(BaseLLMProvider):
    ...
    async def generate_signal(
        ...
        if not self._get_rate_limiter("xai").check("xai"):
            raise Exception("Rate limit exceeded for xAI")
        ...
        try:
            ...
            raise Exception(sanitize_error(e, "xAI"))

        raw_text, tokens = _extract_response_text(result, "xai")
